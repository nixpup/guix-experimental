...
(exwm-input-set-key (kbd "M-S-t") #'exwm-layout-toggle-fullscreen)
...
(defun my/exwm-init ()
  ...
  (start-process "wallpaper" nik "feh" "--bg-fill" "/home/puppy/Pictures/gruvbox_pokemon_marnie_wp_dark.png")
  ;; ---
  ...
  ;; Configure Monitor
  ;; ---
  ;;(start-process "xrandr" nil "xrandr" "--output" "HDMI-0" "--primary" "--mode" "1920x1080" "--rate" "144.00" "--output" "DP-0" "--mode" "2560x1440" "--right-of" "HDMI-0")
  ;; ---
  ;; Configure Mouse
  ;; ---
  ;;(start-process "mouse1" nil "xinput" "set-prop" "'Mad" "Catz" "Global" "MADCATZ" "R.A.T." "8+" "gaming" "mouse'" "'libinput" "Accel" "Profile" "Enabled'" "0" "1" "0")
  ;;(start-process "mouse2" nil "xinput" "set-prop" "'Mad" "Catz" "Global" "MADCATZ" "R.A.T." "8+" "gaming" "mouse'" "'libinput" "Accel" "Speed'" "0.3")
  ;;(start-process "mouse3" nil "xinput" "set-prop" "'Mad" "Catz" "Global'" "'libinput" "Accel" "Profile" "Enabled'" "0" "1" "0"(
  ;;(start-process "mouse4" nil "xinput" "set-prop" "'Mad" "Catz" "Global'" "'libinput" "Accel" "Speed'" "0.3")
